...
class Todolist:
    def __init__(self, root):
        ...
        self.add_option = tk.Button(root, text="ADD TASK",font=FONT, command=self.add_task,background='Green')
        ...
        self.update_option = tk.Button(root, text="UPDATE TASK",font=FONT, command=self.update_task,background='blue')
